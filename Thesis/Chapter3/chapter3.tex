...
\begin{table}
\centering 
\captionof{table}{Popularity of languages in top 3 open source software forges (reproduced from Redmonk \cite{grady2011what})}
\begin{tabular}
 \centering 
