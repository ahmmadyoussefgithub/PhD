...
These are, by no means, the only studies of this nature. Subramanyam and Krishnan \citep{subramanyam2003empirical} conducted similar work with access to a large number of in-house developed codebases, controlling for programming language and software size, confirming the results obtained by Basili et al. These results were further validated in a number of similar studies, each adding its own unique contribution \citep{subramanyam2003empirical, el2001prediction, tang1999empirical, xu2008empirical, malhotra2012fault, el1999validation, cartwright2000empirical}. Table ~\ref{tab:FaultModels} surveys the empirical approach within this research.
